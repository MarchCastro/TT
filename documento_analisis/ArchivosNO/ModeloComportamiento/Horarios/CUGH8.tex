...
\begin{UseCase}{CUGH8}{Editar asignación de profesor a materia}{
...
\begin{UCtrayectoria}{Principal}
	\UCpaso[\UCactor] Introduce su Número de Boleta y Contraseña en el sistema vía la  \IUref{UI23}{Pantalla de Control de Acceso}
	\label{CU17Login}.
	\UCpaso Verifica que el Estudiante sea elegible para inscribirse al Seminario con base en la regla \BRref{BR129}{Determinar si un Estudiante puede inscribir Seminario.} \Trayref{A}. % --Ejemplo de referencia a una trayectoria alternativa
